define([
  ...
  var AudioController = _.extend({
    ...
    setupAudio: function() {
      ...
      // Collect saved text size
      Adapt.audio.textSize = Adapt.offlineStorage.get("audio_textSize");
      // If size is not 1 then presume one hasn't been stored and set to default full
    ...
    changeText: function(value) {
      ...
      // store audio and text preference,
    ...
    onMenuReady: function(view) {
      ...
      if (this.audioEnabled && view.model && view.model.get("_audio") && view.model.get("_audio")._isEnabled && view.model.get('_type') == "menu") {
          try{
