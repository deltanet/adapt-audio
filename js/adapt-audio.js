define(function(require) {
  ...
  // -----
	...
	Adapt.once('app:dataReady', function() {
		...
		if (aAdapt.config.get("_audio") && Adapt.config.get("_audio")._isEnabled && && drawerAudio) {
			var drawerObject = {
  ...
  Adapt.on('articleView:postRender blockView:postRender componentView:postRender', function(view) {
    if (Adapt.config.get("_audio") && Adapt.config.get("_audio")._isEnabled && && view.model.get("_audio")) {
